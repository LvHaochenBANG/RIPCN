...
class Metric(object):
    ...
    def __str__(self):
        """For print"""
        return f"\nmae,rmse,mape,crps,mis,epoch\n{self.metrics['mae']:<7.2f},{self.metrics['rmse']:<7.2f},{self.metrics['mape']:<7.2f},{self.metrics['crps']:<7.2f},{self.metrics['mis']:<7.2f} | {self.best_metrics['epoch'] + 1:<4} "
