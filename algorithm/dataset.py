...
class CleanDataset():
    ...
    def __init__(self, name, feature_file, val_start_idx, spatial):

        self.data_name = name
        self.feature_file = feature_file
        self.val_start_idx = val_start_idx
        self.adj = np.load(spatial)
        # self.label, self.feature = self.read_data()
        
        # self.mean= 229.8431355598314
        # self.std= 145.62553066568907
        # self.mean= 230.0626211612394
        # self.std =145.5997951633169
        # self.mean= 230.26390847345718
        # self.std= 145.5800822595608
        self.mean = 879.5612244417113 
        self.std = 525.9171452888901
